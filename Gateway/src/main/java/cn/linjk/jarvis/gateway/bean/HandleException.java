package cn.linjk.jarvis.gateway.bean;
...
public class HandleException {
    ...
    public Mono<Void> writeError(ServerWebExchange exchange, String error) {
        ...
        ResultInfo resultInfo = ResultInfoUtil.buildError(Constant.NO_LOGIN_CODE, Constant.NO_LOGIN_MESSAGE, request.getURI().getPath());
