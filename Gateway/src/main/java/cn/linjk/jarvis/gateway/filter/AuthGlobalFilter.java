package cn.linjk.jarvis.gateway.filter;

import cn.linjk.jarvis.gateway.bean.HandleException;
import cn.linjk.jarvis.gateway.config.IgnoreUrlsConfig;
...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
    ...
    @Resource private HandleException handleException;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // 校验 token 是否有效
        String checkTokenUrl = "http://auth-service/oauth/check_token?token=".concat(access_token);
        try {
            // 发送远程请求，验证 token
